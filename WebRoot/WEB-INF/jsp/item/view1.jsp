...
<head>
    ...
    <script src="${ctx}/resource/layui/layui.js" charset="utf-8"></script>
...
<div class="width1198 center_yh" style="height: 420px;">
    <div class="left_yh" style="width: 350px;height: 420px;">
        ...
        <div class="layui-carousel" id="test10">
            <div carousel-item="">
                <div><img src="${obj.url1}" height="350" width="350"></div>
                <div><img src="${obj.url2}" height="350" width="350"></div>
                <div><img src="${obj.url3}" height="350" width="350"></div>
                <div><img src="${obj.url4}" height="350" width="350"></div>
                <div><img src="${obj.url5}" height="350" width="350"></div>
            </div>
        </div>
        </div>
    </div>
