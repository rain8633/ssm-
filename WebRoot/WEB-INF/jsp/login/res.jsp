...
<head>
    ...
    <script type="text/javascript">
       function verifyNotNull(str) {
        ...
        function submit() {
            {
                if(! verifyNotNull(document.getElementById("agreement").value))
                {
                    window.alert("请先同意注册协议!");
                    return false;
                }
            }
        }
...
<div class="width100 hidden_yh" style="border-top: 1px solid #ddd">
    <div class="width1200 hidden_yh center_yh" style="margin-top: 75px">
        <form action="${ctx}/login/toRes" method="post" onsubmit="return submit()">
            ...
            <p class="font14 c_66" style="text-indent: 500px;margin-top: 30px;">
                <input type="checkbox" id="agreement" value="我已阅读并同意" >我已阅读并同意<a href="#" class="red">《会员注册协议》</a>和<a href="#" class="red">《隐私保护政策》</a>
            </p>
